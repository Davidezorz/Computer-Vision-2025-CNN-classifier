...
if __name__ == '__main__': 
    ...
    cnn_name = config.model.name                                                # ◀── name of the network
    plot_path = save_path + cnn_name                                            # ◀── initial name of files will be the same
    ...
    cnn  = CNN(image_dims, nn_config, name=cnn_name, init_type=init_type,        # ◀─┬ Instantiating the Convolutional 
